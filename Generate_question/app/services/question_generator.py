...
4. 변화량은 다양해야 해. 예: 0.003, -0.007, 0.009, -0.002, 0.006 등
5. 차원은 반드시 vec_1, vec_2, ..., vec_50 형식으로 표현해야 해.
6. 매번 다른 카테고리의 차원들을 조합해서, 식상하지 않고 새로운 질문을 만들어줘.
7. 응답은 반드시 다음 JSON 형식을 따라야 해:
   {{
     "question": "질문 내용",
     "choice_a": "선택지 A 내용",
     "vectors_a": [
       {{"dimension": "vec_1", "change": 0.007}},
       {{"dimension": "vec_2", "change": -0.003}}
     ],
     "choice_b": "선택지 B 내용",
     "vectors_b": [
       {{"dimension": "vec_1", "change": -0.007}},
